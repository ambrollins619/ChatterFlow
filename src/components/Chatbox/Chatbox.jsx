...
import { handleUpload } from '../../lib/cloudinary_upload'
    ...
    try {
      if(input && messagesId){
        ...
        userIDs.forEach(async (id) => {
          const userChatsRef = doc(db,'chats',id); //getting the reference
          const userChatsSnapshot = await getDoc(userChatsRef); //getting the actual document
